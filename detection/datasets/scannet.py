...
DATASET_ROOT_DIR = "../data/scannet/scannet_instance_data"  ## Replace with path to dataset
...
class ScannetDatasetConfig(object):
    def __init__(self):
        ...
        # Semantic Segmentation Classes. Not used in detection
...
class ScannetDetectionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        instance_bboxes = np.load(os.path.join(self.data_path, scan_name) + "_unaligned_bbox.npy")
