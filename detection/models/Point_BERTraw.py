...
class Block(nn.Module):
    def __init__(self, dim, num_heads, config, mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
                 drop_path=0., act_layer=nn.GELU, norm_layer=nn.LayerNorm, adapt=False):
        super().__init__()
...
class PointTransformerBERTraw(nn.Module):
    ...
    def load_model_from_ckpt(self, name='bert'):
